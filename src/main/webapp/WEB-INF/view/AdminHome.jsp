                            ...
                            <div class="widget-content-left">
                                <div class="btn-group">
                                    <a data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
                                       class="p-0 btn">
                                        <img width="42" class="rounded-circle" src="images/0.png" alt="">
            ...
            <div class="scrollbar-sidebar">
                <div class="app-sidebar__inner">
                    <ul class="vertical-nav-menu">
                        ...
                        <li>
                            <a href="AdminHome" class="mm-active">
                                <i class="metismenu-icon pe-7s-rocket"></i>
                                Manage Users
                            </a>
                        </li>
                        <li>
                            <a href="AdminManagePost" class="mm-active">
                                <i class="metismenu-icon pe-7s-rocket"></i>
                                Manage Posts
                            </a>
                        </li>
                    ...
                    <div class="col-md-6 col-xl-4">
                        <div class="card mb-3 widget-content bg-midnight-bloom">
                            <div class="widget-content-wrapper text-white">
                                <div class="widget-content-left">
                                    <div class="widget-heading">All User</div>
                                    <div class="widget-subheading">in the system</div>
                                </div>
